        ...
        <main className='heroSection'>
            <section className='container justify-around items-center flex mx-auto flex-col sm:flex-col md:flex-row lg:flex-row xl:flex-row sm:justify-center'>
                <div className='text-end me-20 sm:me-4 md:me-5 lg:me-10 xl:me-20 sm:mb-40 md:mb-0 lg:mb-0 xl:mb-0 z-40'>
                    <h3 className='font-light text-black text-xl sm:text-lg md:text-4xl lg:-text-4xl xl:text-4xl mb-4'>Hola soy Larson</h3>
                    <h1 className='font-bold bg-clip-text text-2xl bg-gradient-to-b text-transparent from-violet-400 to-black sm:text-2xl md:text-4xl lg:text-7xlxl xl:text-7xl'>Diseñador & <br /> Desarrollador Web</h1>
                ...
                <h2 className='absolute bottom-10 left-80 text-black text-xl font-light'>Convierte tu presencia en línea en algo impresionante con mi diseño web personalizado</h2>
            </section>
